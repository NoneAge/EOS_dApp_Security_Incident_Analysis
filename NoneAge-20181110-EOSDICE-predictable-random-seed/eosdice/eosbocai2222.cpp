...
void eosbocai2222::reveal(const st_bet &bet)
{
    ...
    print(
        ...
        "|amount=>", bet.amount,
        "|roll_under=>", (int)bet.roll_under,
        "|random_roll=>", (int)random_roll,
        "|payout=>", payout,
        "\n"
    );
    print("[DICE REVEAL2] current_time => ", current_time(), "\n");  
...
void eosbocai2222::reveal1(const st_bet &bet)
{
    ...
    send_defer_action(permission_level{_self, N(active)},
                      ...
                      N(reveal),
                      bet);
    print("[DICE REVEAL1] current_time => ", current_time(), "\n");                  
}
                            ...
                            const string &memo)
{
    ...
    send_defer_action(permission_level{_self, N(active)},
                      ...
                      N(reveal1),
                      _bet);
    print("[DICE] current_time => ", current_time(), "\n");
}
