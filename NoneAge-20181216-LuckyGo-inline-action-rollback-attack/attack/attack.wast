(module
 ...
 (table 3 3 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN6attack2hiEN5eosio5assetE $_ZN6attack8rollbackEN5eosio5assetE)
 (memory $0 1)
 ...
 (data (i32.const 80) "rollback\00")
 (data (i32.const 96) "unable to find key\00")
 ...
 (data (i32.const 336) "dice-noneage-66-user\00")
 (data (i32.const 368) "active\00")
 (data (i32.const 384) "eosbocai2222\00")
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (block $label$0
   ...
   (block $label$21
    ...
    (drop
     (call $_ZN5eosio14execute_actionI6attackS1_JNS_5assetEEEEbPT_MT0_FvDpT1_E
      (i32.add
       (get_local $9)
       (i32.const 40)
      )
 ...
 (func $_ZN6attack2hiEN5eosio5assetE (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN5eosio14execute_actionI6attackS1_JNS_5assetEEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN6attack8rollbackEN5eosio5assetE (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i64)
